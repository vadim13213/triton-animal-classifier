Отлично, я понял. Я возьму структуру из вашего примера `README.md` и адаптирую её под ваш проект, заменив всё на ваши данные: модель на 3 класса (chicken, cow, horse), вашу таблицу результатов нагрузочного тестирования, ваш GitHub-репозиторий и т.д. Фотографии и ссылки на них **убираю** (вы их уже приложили отдельно). Также оставлю только те разделы, которые есть в примере, и добавлю необходимые.
